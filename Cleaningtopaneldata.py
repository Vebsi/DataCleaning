...
# Load Excel files
files = ["C:/Users/Prof/Desktop/data1.xlsx", 
         "C:/Users/Prof/Desktop//data2.xlsx", 
         "C:/Users/Prof/Desktop/data3.xlsx"]
...
# Merge GDP Data
gdp_data = pd.read_excel("C:/Users/Prof/Desktop/gdp.xlsx")
...
# Remove companies with  zero ROA, FCF, ROE values
company_roa_zero_count = panel_data[panel_data['ROA'] == 0].groupby('CN')['ROA'].count()
panel_data = panel_data[~panel_data['CN'].isin(company_roa_zero_count[company_roa_zero_count > 1].index)]

company_fcf_zero_count = panel_data[panel_data['FCF'] == 0].groupby('CN')['FCF'].count()
panel_data = panel_data[~panel_data['CN'].isin(company_fcf_zero_count[company_fcf_zero_count > 1].index)]

company_roe_zero_count = panel_data[panel_data['ROE'] == 0].groupby('CN')['ROE'].count()
panel_data = panel_data[~panel_data['CN'].isin(company_roe_zero_count[company_roe_zero_count > 1].index)]
...
# Save cleaned data
panel_data.to_excel("C:/Users/Prof/Desktop/Cleandata.xlsx", index=False)
# %%
